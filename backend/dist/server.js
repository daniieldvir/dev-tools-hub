...
app.get("/api/tools", (req, res) => {
    try {
        const toolsPath = path_1.default.join(process.cwd(), "data", "tools.json");
        const raw = fs_1.default.readFileSync(toolsPath, "utf-8");
    ...
    try {
        ...
        const completion = await groq.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an expert frontend AI assistant. Always be concise and helpful, and follow the user's instructions exactly.",
                },
                {
                    role: "user",
                    content: prompt,
